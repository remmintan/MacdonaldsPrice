...
class BotManager:
    ...
    def __init__(self):
        ...
        self.__commands = {
            "start": self.start,
            "startText": "Введите сумму (в рублях), которую вы готовы потратить и я подскажу вам несколько заказов, "
                         "которые уложатся в эту сумму.",
            "help": self.help_m,
            "disclaimer": "*Отказ от ответственности:*\nРазработчик бота не сотрудничает с ресторанами быстрого "
                          "питания. Бот является *неоффициальной* разработкой. \nЦены взяты из открытых источников, "
                          "обновляются раз в неделю и *могут быть неактуальны*. \nСервис предоставляется пользователю "
                          "\"как есть\", пользователь использует сервис на свое усмотрение, разработчик не несет "
                          "ответственности за возможные последствия использования. \nСправка бота: /help",
            "about": "Этот бот поможет вам определиться с разнообразным выбором в ресторанах быстрого питания. Просто "
                     "выберите один из доступных ресторанов быстрого питания и введите сумму в рублях, которую вы "
                     "готовы потратить на заказ. Бот предложит несколько вариантов заказа, которые уложатся в эту "
                     "сумму.\n\n/disclaimer - отказ от ответственности",
            ...
            "donate": "*Поддержать:*\n Спасибо, что заинтересовались поддержкой бота!\n Бот располагается на VPS от "
                      "DigitalOcean (5-10$/мес.) и не приносит никакой прибыли.\n Если вы считаете, что любая работа "
                      "должна оплачиваться или хотите поддержать мои разработки, просто пожертвуйте любую сумму на "
                      "развитие бота. \n\n*Яндекс Деньги:* 410012477007394 или [перевод]("
                      "https://money.yandex.ru/to/410012477007394)\n*Paypal:* [перевод]("
                      "https://www.paypal.me/alexmojar/100)\n*Банковская карта:* 5278 8300 6712 3129\n\nЛюбая другая "
                      "помощь или предложения приветствуются. Контакты: /author\n\nСпасибо! Без вашей поддержки я бы "
                      "не справился!",
        ...
        self.__errors = {
            ...
            "toomany": "Вы ввели несколько чисел, мне нужно только одно: сумма (в рублях) которую вы готовы потратить "
                       "на заказ.",
            "notenoughmoney": "Вы ввели очень маленькую сумму, на нее невозможно составить полноценный заказ. "
                              "Минимальная сумма: 50 руб.",
            "firstorder": "У вас еще не было ни одного заказа, сделайте свой первый заказ, отправив боту сумму, "
                          "которую вы готовы потратить на заказ.",
        }
    ...
    def help_m(self):
        help_array = ["*Справка:*\n"
                      "Введите сумму в рублях, которую вы готовы потратить на заказ. Сумму необходимо вводить без "
                      "указания валюты, кавычек или других символов. Например: Если вы хотите, чтобы бот предложил "
                      "зказазы, уложившись в 350 рублей, вам просто надо отправить боту число 350.",
                      "Если была введена сумма более 1000 рублей, она будет автоматически понижена ботом до 1000 "
                      "рублей.",
