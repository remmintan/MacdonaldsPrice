...
def getChats():
	...
	for chat in chats:
		...
		last = "%s %s %i %s:%s" % (getDate(chat.lastRequest.day), getDate(chat.lastRequest.month), chat.lastRequest.year, getDate(chat.lastRequest.hour), getDate(chat.lastRequest.minute))
