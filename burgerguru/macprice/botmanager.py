...
class FFPriceBot:
	...
	def __init__(self, token):
		...
		self.__info = {
			...
			"havenotchoosen":"Выберите пожалуйста ресторан из списка (временно поддерживается только Макдональдс):"
		}
